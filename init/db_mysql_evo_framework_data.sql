...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.rabbitmq.addresses', '192.168.18.132:5672', null, '1', now(), '1', now());
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.rabbitmq.host', '192.168.18.132', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.redis.cluster.nodes', '192.168.18.129:7001, 192.168.18.129:7002, 192.168.18.129:7003, 192.168.18.129:7004, 192.168.18.129:7005, 192.168.18.129:7006', 'Redis集群', '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.sample.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_sample?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.sys.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_sys?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.datadict.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_datadict?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.activiti.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_activiti?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.flowable.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_flowable?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.rabbitmq.addresses', '192.168.204.131:5672', null, '1', now(), '1', now());
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.rabbitmq.host', '192.168.204.131', null, '1', now(), '1', now());
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.redis.cluster.nodes', '192.168.204.132:7001, 192.168.204.132:7002, 192.168.204.132:7003, 192.168.204.132:7004, 192.168.204.132:7005, 192.168.204.132:7006', null, '1', now(), '1', now());
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.framework.datasource.url', 'jdbc:mysql://192.168.204.130:3306/evo_framework?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.sample.datasource.url', 'jdbc:mysql://192.168.204.130:3306/evo_sample?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
