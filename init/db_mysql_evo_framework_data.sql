...
insert into config_properties values (null, 'master', 'evo', 'default', 'evo.demo.datasource.url', 'jdbc:mysql://192.168.18.134:3306/evo_demo?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
...
insert into config_properties values (null, 'master', 'evo', 'blue', 'evo.demo.datasource.url', 'jdbc:mysql://192.168.204.130:3306/evo_demo?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowPublicKeyRetrieval=true', null, '1', now(), '1', now());
