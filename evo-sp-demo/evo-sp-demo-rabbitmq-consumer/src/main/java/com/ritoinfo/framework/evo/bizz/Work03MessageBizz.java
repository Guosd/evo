...
import com.ritoinfo.framework.evo.bizz.consumer.BreakDefaultConsumer;
...
public class Work03MessageBizz {
	...
	public void process() {
		...
		log.info("等待接收消息");
		CommonUtil.basicConsume(channel, QUEUE_NAME, true, new BreakDefaultConsumer(channel));// 中断消息处理
	}
}
