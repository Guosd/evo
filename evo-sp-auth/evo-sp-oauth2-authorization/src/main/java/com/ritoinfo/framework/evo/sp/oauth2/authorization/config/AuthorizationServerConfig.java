...
import com.ritoinfo.framework.evo.sp.oauth2.authorization.extend.mnvc.MobileNumberVerifyCodeTokenGranter;
import com.ritoinfo.framework.evo.sp.oauth2.authorization.extend.token.LoginUserAccessTokenConverter;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	@Autowired
	public AuthorizationServerConfig(DataSource dataSource, RedisConnectionFactory redisConnectionFactory, RedisKeyGenerator redisKeyGenerator, AuthProperties authProperties, AuthenticationManager authenticationManager) {
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		converter.setSigningKey(authProperties.getJwt().getSigningKey());
		return converter;
	}
